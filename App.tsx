                ...
                <div className="w-full flex-1 flex flex-col gap-2 min-h-0 pb-20">
                  ...
                  <div className="p-4 bg-white/5 border border-white/10 rounded-[2rem] backdrop-blur-md shrink-0">
                    <p className="text-[10px] leading-relaxed opacity-60 uppercase font-bold text-left">
                      UNLOCK THE MINER TO GENERATE XP AUTOMATICALLY AND SECURE YOUR AIRDROP ELIGIBILITY. HIGHER MINER LEVELS INCREASE YOUR HOURLY YIELD AND MAXIMIZE YOUR FINAL AIRDROP ALLOCATION.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      },
                      {
                        ...
                        a: "AUTOMATICALLY EARN 20% OF ALL XP GENERATED BY YOUR RECRUIT'S MINER. Your profile dashboard updates automatically with your total referrals and bonus XP whenever your recruits claim their earnings."
                      }
                    ].map((faq, i) => (
